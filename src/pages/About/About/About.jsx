    ...
    <div className="p-5">
      ...
      <div className=" mb-5">
        ...
        <p className="font-lato text-[17px] text-justify  ">
          CNRS is one of the most recognized pro-environmental national NGOs in
          Bangladesh. It was conceptualized in 1993, from Bangladesh Flood
          ...
          and has drawn attention of relevant local, national and international
          actors including government and funding agencies through demonstrating
          innovations in its approaches and producing tangible learning
          outcomes. On behalf of its General Committee, an Executive Committee
          (EC) governs CNRS. CNRS aims to join with others in influencing the
          national development strategy towards directions that support
      ...
      <div className="px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 ">
          ...
          <p className="col-span-2 font-lato text-[#001848] mb-3">
            ...
            that have been adopted to further smoothen the operational aspects.
            These include:
          </p>
        </div>
        {/* Bunch 3 */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 text-[#002060]">
          ...
          <p className="col-span-2 font-lato">
            ...
            A seven-member senior management team (SMT) is formed headed by the
            Executive Director (ED) to facilitate day-to-day functions of CNRS.
          </p>
          {/* 2 */}
          <p className="col-span-1 font-yeseva font-bold md:text-right"></p>
          <p className="col-span-2 font-lato">
            <span className="block font-bold ">Audit committee</span>
            In order to strengthen internal control mechanism, CNRS has adopted
            an “Audit Committee (AC)” constituted with 3 staff members to
            monitor and take necessary actions to comply with the standard
            procedures and policies of CNRS.
          </p>
          {/* 3 */}
          <p className="col-span-1 font-yeseva font-bold md:text-right"></p>
          <p className="col-span-2 font-lato">
            <span className="block font-bold ">Compliance Committee (CC)</span>A
            5-member compliance committee (CC) is formed to oversee the day to
            day compliance issues and risks associated with non-compliance of
            standard procedures and recommend corrective actions.
          </p>
          {/* 4*/}
          <p className="col-span-1 font-yeseva font-bold md:text-right"></p>
          <p className="col-span-2 font-lato">
            <span className="block font-bold ">Gender forum</span>A five-member
            gender forum (GF) aimed at making CNRS a gender sensitive
            organization by facilitating space for women staff members to
            express their views, establishing gender equality, women’s rights
            and gender friendly environment.
          </p>
          {/* 5 */}
          <p className="col-span-1 font-yeseva font-bold md:text-right"></p>
          <p className="col-span-2 font-lato">
            ...
            responsibility as Independent Reviewer (IR) of procurement of goods
            and services on a random basis to ensure compliance of standard
            procedures.
          </p>
        </div>
        {/* Bunch 4 */}
